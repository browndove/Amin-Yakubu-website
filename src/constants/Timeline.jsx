...
const Timeline = () => {
  ...
  return (
    <div>
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical mx-[4rem]">
        <li className=''>
          ...
          <div className="timeline-start md:text-end mb-2">
            ...
            <div onClick={toggleText} className='text-sm font-light mb-8 py-4 px-2 border cursor-pointer'>
              {showFullText ?
  ...
  <li>
    ...
    <div className="timeline-end mb-10">
      ...
      <div onClick={toggleText1} className='text-sm font-light mb-2 py-4 px-2 border cursor-pointer'>
      {showFullText1 ?
  ...
  <li>
    ...
    <div className="timeline-start md:text-end mb-2">
      ...
      <div onClick={toggleText2} className='mb-8 text-sm font-light py-4 px-2 border'>
        {showFullText2 ?
  ...
  <li>
    ...
    <div className="timeline-end mb-10">
      ...
      <div onClick={toggleText3} className='mb-2 text-sm font-light py-4 px-2 border'>
        {showFullText3 ?
  ...
  <li>
    ...
    <div className="timeline-start md:text-end mb-10">
      ...
      <div onClick={toggleText4} className='mb-8 text-sm font-light py-4 px-2 border'>
        {showFullText4 ? 
      "The Apple Watch is a line of smartwatches produced by Apple Inc. It incorporates fitness tracking, health-oriented capabilities, and wireless telecommunication, and integrates with iOS and other Apple products and services"
        : 
        "The Apple Watch is a line of smartwatches produced by Apple Inc. It incorporates fitness tracking, health-oriented..."
        }
        </div>
